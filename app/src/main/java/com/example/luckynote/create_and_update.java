...
public class create_and_update extends AppCompatActivity implements View.OnClickListener {
        ...
        if (view.getId() == R.id.btn_submit) {
            ...
            if (isEdit) {
                ...
                if (result > 0) {
                    ...
                    Toast.makeText(create_and_update.this, "Failed to change note", Toast.LENGTH_SHORT).show();
                }
            } else {
                ...
                if (result > 0) {
                    ...
                    Toast.makeText(create_and_update.this, "Failed to add note", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if (isDialogClose) {
                            ...
                            if (result > 0) {
                                ...
                                Toast.makeText(create_and_update.this, "Failed to delete note", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                })
