package com.example.luckynote.adapter;
...
import com.example.luckynote.CustomOnItemClickListener;
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int position) {
        ...
        holder.cvNote.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Intent intent = new Intent(activity, create_and_update.class);
                intent.putExtra(create_and_update.EXTRA_POSITION, position);
                intent.putExtra(create_and_update.EXTRA_NOTE, listNotes.get(position));
                activity.startActivityForResult(intent, create_and_update.REQUEST_UPDATE);
            }
        }));
    }
